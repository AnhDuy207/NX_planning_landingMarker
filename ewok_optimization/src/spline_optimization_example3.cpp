...
void depthImageCallback(const sensor_msgs::Image::ConstPtr& msg) {
    ...
    //D455 =>K: [389.7030334472656, 0.0, 323.2359924316406, 0.0, 389.7030334472656, 243.83709716796875, 0.0, 0.0, 1.0]
    const float fx = 389.7030334472656; 
    const float fy = 389.7030334472656;
    const float cx = 323.2359924316406;
    const float cy = 243.83709716796875;
